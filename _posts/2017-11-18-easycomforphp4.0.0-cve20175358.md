...
John Page (/AKA Hyp3rlinX/) discovered a stack-based buffer overflows in EasyCom for PHP 4.0.0.29, `php_Easycom5_3_0.dll`. This security issue (*CVE-2017-5358*) allows to a remote attacker to execute arbitrary code via the server argument to the API functions: i5_connect, i5_pconnect, or i5_private_connect.
